...
exclude-result-prefixes="redirect str exslt">
  ...
  <xsl:import href="springas-util.xsl" />
...
<!-- 						<xsl:call-template name="getFeedbackLink">
            ...
            <!--  SPRING ACTIONSCRIPT CUSTOM LINKS  -->
            <xsl:apply-templates select="customs">
              <xsl:with-param name="packageName" select="@packageName"/>
              <xsl:with-param name="moduleName" select="../../../asPackage/@moduleName"/>
            </xsl:apply-templates>
...
<!-- 						<xsl:if test="includeExamples/includeExample/codepart">
					...
					<xsl:text disable-output-escaping="yes"><![CDATA[
						...
						<script type="text/javascript">
							try {
								var pageTracker = _gat._getTracker("UA-10720510-1");
