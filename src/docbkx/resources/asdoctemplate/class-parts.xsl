...
exclude-result-prefixes="str">
	...
	<xsl:template name="classHeader">
        ...
        <tr>
          <td class="classHeaderTableLabel">SVN browsing</td>
          <td>
            <xsl:call-template name="svnBrowseLink">
              <xsl:with-param name="packageName" select="$packageName"/>
        ...
        <tr>
          <td class="classHeaderTableLabel">Fisheye</td>
          <td>
            <xsl:call-template name="fisheyeLink">
              <xsl:with-param name="packageName" select="$packageName"/>
              <xsl:with-param name="name" select="$name"/>
              <xsl:with-param name="moduleName" select="$moduleName"/>
            </xsl:call-template>
