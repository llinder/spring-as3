...
package org.springextensions.actionscript.ioc.config.impl.metadata {
	...
	public class MetadataObjectDefinitionsProviderTest {
		...
		public function testAnnotatedComponentWithExplicitProperties():void {
			...
			var names:Vector.<String> = _provider.internalRegistry.objectDefinitionNames;
			var objDef:IObjectDefinition = _provider.internalRegistry.getObjectDefinition(names[0]);
			assertEquals("ThisValue", objDef.getPropertyDefinitionByName("someProperty").value);
			assertEquals(10, objDef.getPropertyDefinitionByName("someOtherProperty").value);
		}
		...
		public function testAnnotatedComponentWithRefProperties():void {
			...
			var names:Vector.<String> = _provider.internalRegistry.objectDefinitionNames;
			var objDef:IObjectDefinition = _provider.internalRegistry.getObjectDefinition(names[0]);
			assertTrue(objDef.getPropertyDefinitionByName("someProperty").value is RuntimeObjectReference);
			assertTrue(objDef.getPropertyDefinitionByName("someOtherProperty").value is RuntimeObjectReference);
			var rf:RuntimeObjectReference = objDef.getPropertyDefinitionByName("someProperty").value;
			assertEquals("objectName1", rf.objectName);
			rf = objDef.getPropertyDefinitionByName("someOtherProperty").value;
