...
package org.springextensions.actionscript.ioc.config.impl.xml.namespacehandler.impl {
	...
	public class ParsingUtilsTest {
		...
		public function testMapProperties():void {
			...
			assertEquals("c", objectDefinition.getPropertyDefinitionByName("YETAnotherAttribute").value);
		...
		public function testMapReferences():void {
			...
			assertTrue(objectDefinition.getPropertyDefinitionByName("YETAnotherAttribute").value is RuntimeObjectReference);

			assertEquals("a", RuntimeObjectReference(objectDefinition.getPropertyDefinitionByName("anAttribute").value).objectName);
			assertEquals("b", RuntimeObjectReference(objectDefinition.getPropertyDefinitionByName("anotherAttribute").value).objectName);
			assertEquals("c", RuntimeObjectReference(objectDefinition.getPropertyDefinitionByName("YETAnotherAttribute").value).objectName);
		...
		public static function assertPropertiesArray(objectDefinition:IObjectDefinition, property:String, referenceNames:Array):void {
			...
			var arr:Array = objectDefinition.getPropertyDefinitionByName(property).value as Array;
