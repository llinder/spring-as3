...
package org.springextensions.actionscript.ioc.config.impl.xml.namespacehandler.impl.stageprocessing.nodeparser {
	...
	import org.springextensions.actionscript.test.testtypes.stage.TestStageProcessor;
	...
	public class StageProcessorNodeParserTest {
		...
		public static const SIMPLE_XML:XML = new XML("<stage:stageprocessor xmlns:stage='http://www.springactionscript.org/schema/stageprocessing' class='org.springextensions.actionscript.test.testtypes.stage.TestStageProcessor' object-selector='selector'/>");
		...
		public function testParseWithSimpleXML():void {
			...
			assertEquals('org.springextensions.actionscript.test.testtypes.stage.TestStageProcessor', definition.className);
