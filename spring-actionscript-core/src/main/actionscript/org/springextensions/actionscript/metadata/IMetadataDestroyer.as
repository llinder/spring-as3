...
package org.springextensions.actionscript.metadata {
	...
	/**
	 * Describes an object that can process an instance that is annotated with specific metadata.<br/>
	 * This will be typically used to undo the logic that was performed by an <code>IMetadataProcessor</code>.
	 * @author Roland Zwaga
	 */
