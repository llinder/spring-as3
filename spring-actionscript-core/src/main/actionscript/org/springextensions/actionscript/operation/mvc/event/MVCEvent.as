 ...
 */
package org.springextensions.actionscript.core.mvc.event {
	...
	public class MVCEvent extends Event {
		...
		/**
		 * @return The document that is associated with the wrapped event, typically this will be either an <code>Application</code> or <code>Module</code> instance.
		 */
		...
		/**
		 * @return The original <code>Event</code> wrapped by the current <code>MVCEvent</code>.
		 */
		...
		/**
		 * @return An exact copy of the current <code>MVCEvent</code>.
		 */
		...
		/**
		 * @return A <code>String</code> representing the current <code>MVCEvent</code>.
		 */
