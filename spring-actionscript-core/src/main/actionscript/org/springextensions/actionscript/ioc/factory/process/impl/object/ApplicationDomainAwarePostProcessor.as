...
package org.springextensions.actionscript.ioc.factory.process.impl.object {
	...
	public class ApplicationDomainAwarePostProcessor implements IObjectPostProcessor {
		...
		/**
		 * Initializes the current <code>ApplicationDomainAwarePostProcessor</code> instance.
		 * @param objectFactory
		 */
		protected function initProcessor(objectFactory:IObjectFactory):void {
