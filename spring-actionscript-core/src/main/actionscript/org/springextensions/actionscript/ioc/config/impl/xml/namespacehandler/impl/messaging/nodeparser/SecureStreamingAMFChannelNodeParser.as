...
package org.springextensions.actionscript.ioc.config.impl.xml.namespacehandler.impl.messaging.nodeparser {
	 ...
	 */
	public class SecureStreamingAMFChannelNodeParser extends AMFChannelNodeParser {

		/**
		 * Creates a new <code>SecureStreamingAMFChannelNodeParser</code> instance.
		 */
		public function SecureStreamingAMFChannelNodeParser() {
			super();
		}
		...
		override protected function parseInternal(node:XML, context:IXMLObjectDefinitionsParser):IObjectDefinition {
			...
			result.className = ClassUtils.getFullyQualifiedName(SecureStreamingAMFChannel, true);
