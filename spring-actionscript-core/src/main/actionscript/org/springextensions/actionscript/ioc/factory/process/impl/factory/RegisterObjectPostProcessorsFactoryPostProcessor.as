...
package org.springextensions.actionscript.ioc.factory.process.impl.factory {
	 ...
	 * @author Roland Zwaga
	 */
	public class RegisterObjectPostProcessorsFactoryPostProcessor implements IObjectFactoryPostProcessor {

		/**
		 * Creates a new <code>RegisterObjectPostProcessorsFactoryPostProcessor</code> instance.
		 *
		 */
		public function RegisterObjectPostProcessorsFactoryPostProcessor() {
			super();
		}
